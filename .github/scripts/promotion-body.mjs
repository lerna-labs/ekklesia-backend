...
const intros = {
  staging:
    "Merging this promotes the queued changes into `staging`, which builds a release-candidate tarball for the preprod server. Version bumps are cut later, on `main`.",
  main:
