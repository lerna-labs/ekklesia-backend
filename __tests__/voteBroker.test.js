...
import { buildSigningPayload, buildEvidence, voteHash, finalizeEvidence } from "../helper/voteBroker.js";
...
describe("voteBroker payload", () => {
  ...
  test("finalizeEvidence updates hash when witnesses change", () => {
    ...
    const { evidence, voteHash: postHash } = finalizeEvidence(base, {
      witnesses: [{ key: "aa".repeat(28), coseSign1Hex: "deadbeef", coseKeyHex: "", signature: "" }],
    });
