...
// This repo releases as a source tarball attached to a GitHub Release, not an
// npm package, so this stands in for `changeset publish` -- the pushed tag is
// what the publish workflow (.github/workflows/publish.yml) builds from.
...
// pending changeset, not only right after a version bump. Skip if the tag
