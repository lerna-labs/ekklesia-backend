...
const voterJwt = jwt.sign({ userId: voterId, signType: 'stake', multiSig: false }, secret, {
...
console.log(
  `[castVote] signing merkleRoot=${messageToSign.slice(0, 16)}… via cardano-signer (${skeyPath})`,
);
