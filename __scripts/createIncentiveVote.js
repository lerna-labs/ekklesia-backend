...
const proposal1 = new Proposal({
  ...
  ballotId: ballot._id,
  description:
    'Introduces a new parameter L to cap a pool’s effective stake relative to its pledge, discouraging highly under-pledged / split pools and aiming to improve sybil resistance and decentralization without penalizing well-pledged small pools.',
  data: {
    links: [
      { name: 'CIP-50 text', url: 'https://cips.cardano.org/cip/CIP-50' },
      {
        name: 'CIP-50 GitHub Discussion',
        url: 'https://github.com/cardano-foundation/CIPs/pull/1042',
      },
      {
        name: 'CIP-50 Cardano Forum Discussion',
        url: 'https://forum.cardano.org/t/cip-0050-pledge-leverage-based-staking-rewards',
      },
      {
        name: 'CIP-50 RSS Simulation Engine Pull Request',
        url: 'https://github.com/Blockchain-Technology-Lab/Rewards-Sharing-Simulation-Engine/pull/11',
      },
      {
        name: 'Cardano Foundation CIP-50 Table Talk',
        url: 'https://www.youtube.com/live/dGymb5wCX8Y',
      },
      {
        name: 'Parameter Committee CIP-50 Presentation',
        url: 'https://docs.google.com/presentation/d/1foroY6UjFRyCicKE8QkrOpDgqS5_NrS-qN6u6HHhWHA',
      },
      {
        name: 'CIP-50 Modeling (select CIP-50 under formula and adjust L slider)',
        url: 'https://spo-incentives.vercel.app',
      },
...
const proposal2 = new Proposal({
  ...
  data: {
    links: [
      ...
      {
        name: 'Chart showing Stake/Wallets affected by values of L (snapshot from 15 October, 2025)',
        url: 'https://raw.githubusercontent.com/Cerkoryn/governance-reference/refs/heads/main/L_values.png',
      },
    ],
  },
  voteType: 'scale',
...
const proposal3 = new Proposal({
  ...
  ballotId: ballot._id,
  description:
    'Introduces a new parameter **delegatorInactivity**, measured in epochs, as a proof-of-life for each wallet delegated to a stake pool or dRep.  Expired (inactive) wallets don’t earn rewards or contribute voting power until they are reactivated. Additionally, the full rewards pot is distributed among eligible participants instead of returning a portion to the reserve during rewards calculation.',
  data: {
    links: [
      { name: 'CIP-163 text', url: 'https://cips.cardano.org/cip/CIP-163' },
      {
        name: 'CIP-163 GitHub Discussion',
        url: 'https://github.com/cardano-foundation/CIPs/pull/1077',
      },
      {
        name: 'CIP-163 Cardano Forum Discussion',
        url: 'https://forum.cardano.org/t/cip-0163-time-bound-delegation-with-dynamic-rewards',
      },
      { name: 'Cardano Foundation CIP-163 Seminar', url: 'https://youtu.be/zxcuOqHe7zA' },
      {
        name: 'Cardano Foundation CIP-163 Seminar Slides',
        url: 'https://docs.google.com/presentation/d/1m_s0yymahQjyE21s1VgC6CgYC0K4mjP2YgjnIGzUhNo',
      },
      {
        name: 'CIP-163 Modeling (select CIP-163 under rewards and adjust Staked Ratio & k sliders)',
        url: 'https://spo-incentives.vercel.app',
      },
...
const proposal4 = new Proposal({
  ...
  ballotId: ballot._id,
  description:
    '**delegatorInactivity** is the number of epochs a wallet can go without making a transaction before it becomes ineligible for rewards/governance.  Any transaction that records a witness from the wallet’s stake credential will refresh the **delegatorInactivity** duration for that wallet.  This change will be applied retroactively.',
  data: {
    links: [
      {
        name: 'CIP-163 Modeling (select CIP-163 under rewards and adjust Staked Ratio & k sliders)',
      ...
      {
        name: 'CIP-163 Inactive Stake by Pool Search',
        url: 'https://earncoinpool.com/CIP-163.html',
      },
      {
        name: 'Chart showing Stake/Wallets affected by values of delegatorInactivity (snapshot from 15 October, 2025)',
        url: 'https://raw.githubusercontent.com/Cerkoryn/governance-reference/refs/heads/main/delegatorInactivity_values.jpg',
      },
    ],
  },
  voteType: 'scale',
