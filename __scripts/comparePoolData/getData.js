...
try {
    for (const pool of pools) {
        const requestCalidusKeys = await fetch(`https://preprod.koios.rest/api/v1/pool_calidus_keys?pool_id_bech32=eq.${pool.pool_id_bech32}`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
            },
...
try {
    for (const pool of pools) {
        const requestPoolInfo = await fetch(`https://cardano-preprod.blockfrost.io/api/v0/pools/${pool.pool_id_bech32}`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
                "project_id": BF_TOKEN,
