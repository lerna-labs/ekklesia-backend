...
// default proposal with abstain
const newDefaultProposal = new Proposal({
...
await newDefaultProposal.save();
console.log('Proposal created successfully:', newDefaultProposal._id);

// budget proposal
// abstain allowed
const newBudgetProposal = new Proposal({
  title: 'Budget Proposal: Abstain Allowed',
  ballotId: ballot._id,
  description:
    'A budget proposal, total budget is 3, all items have the same cost of 1. Abstain is allowed.',
  data: {
    collapsible: {
      title: 'Information',
      content:
        'Below are the items for the budget proposal. Each item includes a brief description and a link to more detailed information. Please review these items to inform your voting decisions.',
      items: [
        {
          id: 1,
          title: 'Avocado',
    ...
    links: [
      {
        name: 'Process Overview and Information',
        url: 'https://intersect.gitbook.io/executive-director-hiring',
      },
    ],
  },
  voteType: 'budget',
...
await newBudgetProposal.save();
console.log('Proposal created successfully:', newBudgetProposal._id);

// scale proposal
// abstain not allowed
const newScaleProposal = new Proposal({
