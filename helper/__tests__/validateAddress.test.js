...
const testnet_enterprise_key_addr = "addr_test1vp9r3mwucuhwqyj3vg7gdlyam2xurku0xj6f9qgamh5vefcw6shw9";

const mainnet_enterprise_script_addr = "addr1wy0adahffetszp9fg84qj8lek7vpvr5chga2ljtumu6fx0qtdy49p";
const testnet_enterprise_script_addr = "addr_test1wq0adahffetszp9fg84qj8lek7vpvr5chga2ljtumu6fx0qs9sf2y";

const mainnet_key_key_addr = "addr1q99r3mwucuhwqyj3vg7gdlyam2xurku0xj6f9qgamh5vefccd4u3lk4wm9sjz2zs7mg2vlgtf8ru4v0p0truedrwm67ske0y8z";
const testnet_key_key_addr = "addr_test1qp9r3mwucuhwqyj3vg7gdlyam2xurku0xj6f9qgamh5vefccd4u3lk4wm9sjz2zs7mg2vlgtf8ru4v0p0truedrwm67s40jyta";

const mainnet_script_key_addr = "addr1zy0adahffetszp9fg84qj8lek7vpvr5chga2ljtumu6fx0qcd4u3lk4wm9sjz2zs7mg2vlgtf8ru4v0p0truedrwm67su4awmc";
const testnet_script_key_addr = "addr_test1zq0adahffetszp9fg84qj8lek7vpvr5chga2ljtumu6fx0qcd4u3lk4wm9sjz2zs7mg2vlgtf8ru4v0p0truedrwm67slrqwh8";

const mainnet_key_script_addr = "addr1y99r3mwucuhwqyj3vg7gdlyam2xurku0xj6f9qgamh5vefcl6mmwjnjhqyz2js02py0lnduczc8f3w364lyhehe5jv7qr3uuaz";
const testnet_key_script_addr = "addr_test1yp9r3mwucuhwqyj3vg7gdlyam2xurku0xj6f9qgamh5vefcl6mmwjnjhqyz2js02py0lnduczc8f3w364lyhehe5jv7qq8pu3a";

const mainnet_script_script_addr = "addr1xy0adahffetszp9fg84qj8lek7vpvr5chga2ljtumu6fx0ql6mmwjnjhqyz2js02py0lnduczc8f3w364lyhehe5jv7qfawkpc";
const testnet_script_script_addr = "addr_test1xq0adahffetszp9fg84qj8lek7vpvr5chga2ljtumu6fx0ql6mmwjnjhqyz2js02py0lnduczc8f3w364lyhehe5jv7q2tnkd8";
...
const testnet_stake_script_addr = "stake_test17q0adahffetszp9fg84qj8lek7vpvr5chga2ljtumu6fx0qsdw3aw";

const payment_address_hex = "004a38eddcc72ee01251623c86fc9dda8dc1db8f34b492811ddde8cca7186d791fdaaed961212850f6d0a67d0b49c7cab1e17ac7ccb46edebd";
...
describe("general tests", () => {
    ...
    test("undefined signer type", () => {
        ...
        expect(validateAddress(stake_address))
            .toEqual({
...
describe("validate payment addresses", () => {
    test("mainnet enterprise key address", () => {
        expect(validateAddress(mainnet_enterprise_key_addr, "addr"))
            .toEqual(mainnet_enterprise_key_addr);
    });
});
...
describe("validate stake addresses", () => {
    test("invalid testnet stake address", () => {
        ...
        expect(validateAddress(stake_address, "stake"))
            .toEqual({"error": "Invalid address format"});
    });

    test("mainnet stake key address", () => {
        expect(validateAddress(mainnet_stake_key_addr, "stake"))
            .toBe(mainnet_stake_key_addr);
    });

    test("mainnet stake script address", () => {
        expect(validateAddress(mainnet_stake_script_addr, "stake"))
            .toBe(mainnet_stake_script_addr);
    });

    test("testnet stake address", () => {
        expect(validateAddress(testnet_stake_key_addr, "stake"))
            .toBe(testnet_stake_key_addr);
    });

    test("testnet stake script address", () => {
        expect(validateAddress(testnet_stake_script_addr, "stake"))
            .toBe(testnet_stake_script_addr);
    });
    ...
    test("testnet stake address hex", () => {
        ...
        expect(validateAddress(stake_address_hex, "stake"))
    ...
    test("testnet payment address hex", () => {
        expect(validateAddress(payment_address_hex, "addr"))
            .toBe("addr_test1qp9r3mwucuhwqyj3vg7gdlyam2xurku0xj6f9qgamh5vefccd4u3lk4wm9sjz2zs7mg2vlgtf8ru4v0p0truedrwm67s40jyta");
    });
...
describe("validate DRep IDs", () => {
    test("valid CIP-129 key DRep", () => {
        ...
        expect(validateAddress(drep_id, "drep"))
            .toEqual({
    ...
    test("valid DRep PubKey", () => {
        ...
        expect(validateAddress(drep_pub_key, "drep"))
            .toEqual({
...
describe("validate hex to bech32 conversion", () => {
    test("hex to DRep ID", () => {
        ...
        expect(pubKeyToBech32(drep_hex, "drep"))
            .toEqual({
                "cip105": "drep17vzth56sg9pyzsan7ljf3n2nf82zf6nm3z4tf6smtffpsr7tu9d",
                "cip129": "drep1ytesfw7n2pq5ys2rk0m7fxxd2dyagf820wy24d82rdd9yxqfm4qjg",
                "isScript": false
